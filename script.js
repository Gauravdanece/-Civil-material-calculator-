...
function calculateConcrete() {
    ...
    const cementBags = volume * 6.0; // Updated to 6.0 bags
...
function calculateSteel() {
    const length = parseFloat(document.getElementById('steel-length').value) || 0;
...
function calculatePlaster() {
    const length = parseFloat(document.getElementById('plaster-length').value) || 0;
    const height = parseFloat(document.getElementById('plaster-height').value) || 0;
